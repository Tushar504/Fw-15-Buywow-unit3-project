...
<div class="login-div">
	<ul>
		...
		<li> <i class="fa fa-arrow-circle-left"></i>  Log in</li>

		<li> <i class="fa fa-user" aria-hidden="true"></i>  Register</li>
		<li><i class="fa fa-shopping-bag" aria-hidden="true"></i>  View cart</li>
...
<div class="checkout_sid">
	...
	<div class="checkout_sid2">
		...
		<button>Check out our offering</button>
	</div>
